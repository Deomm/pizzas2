...
class Queso: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if finalizarB {
            ...
            sigVista.quesoAnterior = eleccion.text!
    ...
    @IBAction func mozarella(_ sender: Any) {
        
        eleccion.text = "Mozarella"
    }
    @IBAction func cheddar(_ sender: Any) {
        
        eleccion.text = "Cheddar"
    }
    @IBAction func parmesano(_ sender: Any) {
        
        eleccion.text = "Parmesano"
    }
    @IBAction func sinQueso(_ sender: Any) {
        
        eleccion.text = "Sin queso"
    }
